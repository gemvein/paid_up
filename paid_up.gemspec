...
# -*- encoding: utf-8 -*-
# stub: paid_up 0.13.23 ruby lib

Gem::Specification.new do |s|
  s.name = "paid_up".freeze
  s.version = "0.13.23".freeze
  ...
  s.add_runtime_dependency(%q<haml-rails>.freeze, [">= 1".freeze, "< 3".freeze])
  s.add_runtime_dependency(%q<haml>.freeze, [">= 5".freeze, "< 7".freeze])
  ...
  s.add_runtime_dependency(%q<uglifier>.freeze, [">= 2.7".freeze, "< 5".freeze])
  s.add_runtime_dependency(%q<bootstrap_leather>.freeze, [">= 0.10.14".freeze, "< 0.11".freeze])
  s.add_runtime_dependency(%q<chronic>.freeze, ["~> 0.10".freeze])
  s.add_runtime_dependency(%q<money>.freeze, ["~> 6.5".freeze])
  s.add_runtime_dependency(%q<cancancan>.freeze, [">= 1".freeze, "< 4".freeze])
  s.add_runtime_dependency(%q<devise>.freeze, [">= 3.4".freeze, "< 5".freeze])
  s.add_runtime_dependency(%q<rolify>.freeze, ["~> 6".freeze])
  s.add_runtime_dependency(%q<stripe>.freeze, [">= 13".freeze, "< 14".freeze])
  s.add_development_dependency(%q<dotenv-rails>.freeze, ["~> 2.2".freeze])
  s.add_development_dependency(%q<coffeelint>.freeze, ["~> 1.14".freeze])
  s.add_development_dependency(%q<juwelier>.freeze, ["~> 2".freeze])
  s.add_development_dependency(%q<nokogiri>.freeze, [">= 1.7".freeze, "< 2".freeze])
  s.add_development_dependency(%q<pre-commit>.freeze, ["~> 0.32".freeze])
  s.add_development_dependency(%q<rubocop>.freeze, [">= 0.49".freeze, "< 1".freeze])
  s.add_development_dependency(%q<web-console>.freeze, [">= 3".freeze, "< 5".freeze])
  s.add_development_dependency(%q<bootstrap-sass>.freeze, [">= 3.3".freeze, "< 4".freeze])
  s.add_development_dependency(%q<factory_bot_rails>.freeze, [">= 4.8".freeze, "< 6".freeze])
  s.add_development_dependency(%q<forgery>.freeze, ["~> 0.6".freeze])
  s.add_development_dependency(%q<rails-controller-testing>.freeze, ["~> 1".freeze])
  s.add_development_dependency(%q<rspec-rails>.freeze, [">= 4.0.0.beta3".freeze])
  s.add_development_dependency(%q<sass-rails>.freeze, [">= 5".freeze, "< 7".freeze])
  s.add_development_dependency(%q<sqlite3>.freeze, [">= 1.4".freeze, "< 2".freeze])
end
